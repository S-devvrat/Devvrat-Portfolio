      ...
      >
        <div className="grid lg:grid-cols-2 gap-16 items-center w-full">
          ...
          <div className="space-y-8">
            ...
            <div className="inline-flex items-center gap-3 px-4 py-3 mt-4 rounded-2xl bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 backdrop-blur-sm group hover:border-blue-500/40 transition-all duration-300">
          ...
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-br from-slate-800/40 to-slate-900/20 backdrop-blur-xl border border-slate-700/30 rounded-3xl p-8 lg:p-12 shadow-2xl shadow-blue-500/10">
